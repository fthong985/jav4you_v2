...
export async function getRecomms(code: string) {
  try {
    const url = `https://client-rapi-missav.recombee.com/missav-default/batch/?${"frontend_timestamp=1739557908&frontend_sign=022b55a28ea2b027669348df799f3479299bd533"}`;
